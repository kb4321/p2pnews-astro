...
export default {
    ...
    methods: {
        getPosts() {
            ...
            fetch(`https://zxhxtnrydorztwzysdqj.supabase.co/rest/v1/articles?select=id,title,slug,publishedAt,sourceDomain,sourceName,score&sourceDomain=eq.${source}&limit=${limit}&order=publishedAt.desc`, { headers, cache: "no-cache"})
